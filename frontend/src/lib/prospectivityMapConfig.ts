...
export const MINE_BOUNDARIES: Record<string, MineBoundaryConfig> = {
  ...
  'kandri': {
    ...
    primaryEvidence: 'Sand stowing effective (0% subsidence); Weak Hangwall Contact limiting depth',
    reserveNote: 'Expanding below -600\' L requires equipment upgrade due to >15.6 MPa stress',
  },
  'beldongri': {
    id: 'beldongri',
    name: 'Beldongri Mine',
    center: [79.289, 21.337],
    zoom: 14.2,
    minZoom: 11.0,
    maxZoom: 18.0,
    bounds: [[79.230, 21.280], [79.340, 21.390]],
    district: 'Nagpur',
    state: 'Maharashtra',
    type: 'Underground',
    prospectivityGeojson: '/prospectivity/nagpur.geojson',
    primaryEvidence: 'Stream Sediment Anomaly (1.64% MnO) & Confirmed Lease Boundary',
    reserveNote: 'Closest lease match of the Nagpur group; high stream sediment Mn anomaly',
  },
  'munsar': {
    id: 'munsar',
    name: 'Munsar Mine',
