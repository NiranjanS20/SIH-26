...
export const PORTFOLIO_MINES_DATA: Record<string, DetailedMineStat> = {
  ...
  chikla: {
    ...
    monthlyOutput: 6800,
    monthlyTarget: 7500,
    provedReservesMT: 8.4,
    avgGradePct: 42.5,
    gradeTier: 'Medium (38–44%)',
    strippingRatioOrHoisting: '220 m Vertical Hoist',
    recoveryRatePct: 85.2,
    waterRecycledPct: 86.5,
    energyKwhPerTon: 33.4,
    dispatchRakesPerMonth: 1.8,
    monthlyTrend: [
      { month: 'Apr', actual: 7200, target: 7500, forecast: 7200 },
      { month: 'May', actual: 7400, target: 7500, forecast: 7400 },
      { month: 'Jun', actual: 6900, target: 7500, forecast: 6900, isMonsoon: true },
      { month: 'Jul', actual: 6500, target: 7500, forecast: 6500, isMonsoon: true },
      { month: 'Aug', actual: 6800, target: 7500, forecast: 6800, isMonsoon: true },
      { month: 'Sep', actual: null, target: 7500, forecast: 7000, isMonsoon: true },
      { month: 'Oct', actual: null, target: 7500, forecast: 7450 },
      { month: 'Nov', actual: null, target: 7500, forecast: 7600 },
      { month: 'Dec', actual: null, target: 7500, forecast: 7700 },
      { month: 'Jan', actual: null, target: 7500, forecast: 7500 },
      { month: 'Feb', actual: null, target: 7500, forecast: 7350 },
      { month: 'Mar', actual: null, target: 7500, forecast: 7800 },
    ],
    gradeBreakdown: {
      highGrade44Plus: 40,
      mediumGrade38To44: 48,
      lowGradeBelow38: 12,
      emdElectrolytic: 0,
    },
  },
