...
`;
//#endregion
//#region ../node_modules/@paper-design/shaders/dist/shaders/lens-distortion.js
var lensDistortionMeta = { maxSamples: 50 };
...
var MeshGradient = (0, import_react.memo)(function MeshGradientImpl({ speed = defaultPreset$29.params.speed, frame = defaultPreset$29.params.frame, colors = defaultPreset$29.params.colors, distortion = defaultPreset$29.params.distortion, swirl = defaultPreset$29.params.swirl, grainMixer = defaultPreset$29.params.grainMixer, grainOverlay = defaultPreset$29.params.grainOverlay, fit = defaultPreset$29.params.fit, rotation = defaultPreset$29.params.rotation, scale = defaultPreset$29.params.scale, originX = defaultPreset$29.params.originX, originY = defaultPreset$29.params.originY, offsetX = defaultPreset$29.params.offsetX, offsetY = defaultPreset$29.params.offsetY, worldWidth = defaultPreset$29.params.worldWidth, worldHeight = defaultPreset$29.params.worldHeight, ...props }) {
	const uniforms = {
...
var SmokeRing = (0, import_react.memo)(function SmokeRingImpl({ speed = defaultPreset$28.params.speed, frame = defaultPreset$28.params.frame, colorBack = defaultPreset$28.params.colorBack, colors = defaultPreset$28.params.colors, noiseScale = defaultPreset$28.params.noiseScale, thickness = defaultPreset$28.params.thickness, radius = defaultPreset$28.params.radius, innerShape = defaultPreset$28.params.innerShape, noiseIterations = defaultPreset$28.params.noiseIterations, fit = defaultPreset$28.params.fit, scale = defaultPreset$28.params.scale, rotation = defaultPreset$28.params.rotation, originX = defaultPreset$28.params.originX, originY = defaultPreset$28.params.originY, offsetX = defaultPreset$28.params.offsetX, offsetY = defaultPreset$28.params.offsetY, worldWidth = defaultPreset$28.params.worldWidth, worldHeight = defaultPreset$28.params.worldHeight, ...props }) {
	const uniforms = {
...
var NeuroNoise = (0, import_react.memo)(function NeuroNoiseImpl({ speed = defaultPreset$27.params.speed, frame = defaultPreset$27.params.frame, colorFront = defaultPreset$27.params.colorFront, colorMid = defaultPreset$27.params.colorMid, colorBack = defaultPreset$27.params.colorBack, brightness = defaultPreset$27.params.brightness, contrast = defaultPreset$27.params.contrast, fit = defaultPreset$27.params.fit, scale = defaultPreset$27.params.scale, rotation = defaultPreset$27.params.rotation, originX = defaultPreset$27.params.originX, originY = defaultPreset$27.params.originY, offsetX = defaultPreset$27.params.offsetX, offsetY = defaultPreset$27.params.offsetY, worldWidth = defaultPreset$27.params.worldWidth, worldHeight = defaultPreset$27.params.worldHeight, ...props }) {
	const uniforms = {
...
var DotOrbit = (0, import_react.memo)(function DotOrbitImpl({ speed = defaultPreset$26.params.speed, frame = defaultPreset$26.params.frame, colorBack = defaultPreset$26.params.colorBack, colors = defaultPreset$26.params.colors, size = defaultPreset$26.params.size, sizeRange = defaultPreset$26.params.sizeRange, spreading = defaultPreset$26.params.spreading, stepsPerColor = defaultPreset$26.params.stepsPerColor, fit = defaultPreset$26.params.fit, scale = defaultPreset$26.params.scale, rotation = defaultPreset$26.params.rotation, originX = defaultPreset$26.params.originX, originY = defaultPreset$26.params.originY, offsetX = defaultPreset$26.params.offsetX, offsetY = defaultPreset$26.params.offsetY, worldWidth = defaultPreset$26.params.worldWidth, worldHeight = defaultPreset$26.params.worldHeight, ...props }) {
	const uniforms = {
		u_colorBack: getShaderColorFromString(colorBack),
		u_colors: colors.map(getShaderColorFromString),
		u_colorsCount: colors.length,
...
var DotGrid = (0, import_react.memo)(function DotGridImpl({ colorBack = defaultPreset$25.params.colorBack, colorFill = defaultPreset$25.params.colorFill, colorStroke = defaultPreset$25.params.colorStroke, size = defaultPreset$25.params.size, gapX = defaultPreset$25.params.gapX, gapY = defaultPreset$25.params.gapY, strokeWidth = defaultPreset$25.params.strokeWidth, sizeRange = defaultPreset$25.params.sizeRange, opacityRange = defaultPreset$25.params.opacityRange, shape = defaultPreset$25.params.shape, fit = defaultPreset$25.params.fit, scale = defaultPreset$25.params.scale, rotation = defaultPreset$25.params.rotation, originX = defaultPreset$25.params.originX, originY = defaultPreset$25.params.originY, offsetX = defaultPreset$25.params.offsetX, offsetY = defaultPreset$25.params.offsetY, worldWidth = defaultPreset$25.params.worldWidth, worldHeight = defaultPreset$25.params.worldHeight, maxPixelCount = 20358144, ...props }) {
	const uniforms = {
		u_colorBack: getShaderColorFromString(colorBack),
...
var SimplexNoise = (0, import_react.memo)(function SimplexNoiseImpl({ speed = defaultPreset$24.params.speed, frame = defaultPreset$24.params.frame, colors = defaultPreset$24.params.colors, stepsPerColor = defaultPreset$24.params.stepsPerColor, softness = defaultPreset$24.params.softness, fit = defaultPreset$24.params.fit, scale = defaultPreset$24.params.scale, rotation = defaultPreset$24.params.rotation, originX = defaultPreset$24.params.originX, originY = defaultPreset$24.params.originY, offsetX = defaultPreset$24.params.offsetX, offsetY = defaultPreset$24.params.offsetY, worldWidth = defaultPreset$24.params.worldWidth, worldHeight = defaultPreset$24.params.worldHeight, ...props }) {
	const uniforms = {
		u_colors: colors.map(getShaderColorFromString),
		u_colorsCount: colors.length,
		u_stepsPerColor: stepsPerColor,
...
var Metaballs = (0, import_react.memo)(function MetaballsImpl({ speed = defaultPreset$23.params.speed, frame = defaultPreset$23.params.frame, colorBack = defaultPreset$23.params.colorBack, colors = defaultPreset$23.params.colors, size = defaultPreset$23.params.size, count = defaultPreset$23.params.count, fit = defaultPreset$23.params.fit, rotation = defaultPreset$23.params.rotation, scale = defaultPreset$23.params.scale, originX = defaultPreset$23.params.originX, originY = defaultPreset$23.params.originY, offsetX = defaultPreset$23.params.offsetX, offsetY = defaultPreset$23.params.offsetY, worldWidth = defaultPreset$23.params.worldWidth, worldHeight = defaultPreset$23.params.worldHeight, ...props }) {
	const uniforms = {
		u_colorBack: getShaderColorFromString(colorBack),
		u_colors: colors.map(getShaderColorFromString),
		u_colorsCount: colors.length,
...
var Waves = (0, import_react.memo)(function WavesImpl({ colorFront = defaultPreset$22.params.colorFront, colorBack = defaultPreset$22.params.colorBack, shape = defaultPreset$22.params.shape, frequency = defaultPreset$22.params.frequency, amplitude = defaultPreset$22.params.amplitude, spacing = defaultPreset$22.params.spacing, proportion = defaultPreset$22.params.proportion, softness = defaultPreset$22.params.softness, fit = defaultPreset$22.params.fit, scale = defaultPreset$22.params.scale, rotation = defaultPreset$22.params.rotation, offsetX = defaultPreset$22.params.offsetX, offsetY = defaultPreset$22.params.offsetY, originX = defaultPreset$22.params.originX, originY = defaultPreset$22.params.originY, worldWidth = defaultPreset$22.params.worldWidth, worldHeight = defaultPreset$22.params.worldHeight, maxPixelCount = 20358144, ...props }) {
	const uniforms = {
		u_colorFront: getShaderColorFromString(colorFront),
		u_colorBack: getShaderColorFromString(colorBack),
		u_shape: shape,
...
var PerlinNoise = (0, import_react.memo)(function PerlinNoiseImpl({ speed = defaultPreset$21.params.speed, frame = defaultPreset$21.params.frame, colorFront = defaultPreset$21.params.colorFront, colorBack = defaultPreset$21.params.colorBack, proportion = defaultPreset$21.params.proportion, softness = defaultPreset$21.params.softness, octaveCount = defaultPreset$21.params.octaveCount, persistence = defaultPreset$21.params.persistence, lacunarity, fit = defaultPreset$21.params.fit, worldWidth = defaultPreset$21.params.worldWidth, worldHeight = defaultPreset$21.params.worldHeight, scale = defaultPreset$21.params.scale, rotation = defaultPreset$21.params.rotation, originX = defaultPreset$21.params.originX, originY = defaultPreset$21.params.originY, offsetX = defaultPreset$21.params.offsetX, offsetY = defaultPreset$21.params.offsetY, ...props }) {
	const uniforms = {
		u_colorBack: getShaderColorFromString(colorBack),
		u_colorFront: getShaderColorFromString(colorFront),
		u_proportion: proportion,
		u_softness: softness ?? defaultPreset$21.params.softness,
		u_octaveCount: octaveCount ?? defaultPreset$21.params.octaveCount,
		u_persistence: persistence ?? defaultPreset$21.params.persistence,
		u_lacunarity: lacunarity ?? defaultPreset$21.params.lacunarity,
		u_fit: ShaderFitOptions[fit],
		u_scale: scale,
		u_rotation: rotation,
		u_offsetX: offsetX,
...
var Voronoi = (0, import_react.memo)(function VoronoiImpl({ speed = defaultPreset$20.params.speed, frame = defaultPreset$20.params.frame, colors = defaultPreset$20.params.colors, stepsPerColor = defaultPreset$20.params.stepsPerColor, colorGlow = defaultPreset$20.params.colorGlow, colorGap = defaultPreset$20.params.colorGap, distortion = defaultPreset$20.params.distortion, gap = defaultPreset$20.params.gap, glow = defaultPreset$20.params.glow, fit = defaultPreset$20.params.fit, scale = defaultPreset$20.params.scale, rotation = defaultPreset$20.params.rotation, originX = defaultPreset$20.params.originX, originY = defaultPreset$20.params.originY, offsetX = defaultPreset$20.params.offsetX, offsetY = defaultPreset$20.params.offsetY, worldWidth = defaultPreset$20.params.worldWidth, worldHeight = defaultPreset$20.params.worldHeight, ...props }) {
	const uniforms = {
		u_colors: colors.map(getShaderColorFromString),
		u_colorsCount: colors.length,
		u_stepsPerColor: stepsPerColor,
...
var Warp = (0, import_react.memo)(function WarpImpl({ speed = defaultPreset$19.params.speed, frame = defaultPreset$19.params.frame, colors = defaultPreset$19.params.colors, proportion = defaultPreset$19.params.proportion, softness = defaultPreset$19.params.softness, distortion = defaultPreset$19.params.distortion, swirl = defaultPreset$19.params.swirl, swirlIterations = defaultPreset$19.params.swirlIterations, shapeScale = defaultPreset$19.params.shapeScale, shape = defaultPreset$19.params.shape, fit = defaultPreset$19.params.fit, scale = defaultPreset$19.params.scale, rotation = defaultPreset$19.params.rotation, originX = defaultPreset$19.params.originX, originY = defaultPreset$19.params.originY, offsetX = defaultPreset$19.params.offsetX, offsetY = defaultPreset$19.params.offsetY, worldWidth = defaultPreset$19.params.worldWidth, worldHeight = defaultPreset$19.params.worldHeight, ...props }) {
	const uniforms = {
		u_colors: colors.map(getShaderColorFromString),
		u_colorsCount: colors.length,
		u_proportion: proportion,
...
var Spiral = (0, import_react.memo)(function SpiralImpl({ speed = defaultPreset$17.params.speed, frame = defaultPreset$17.params.frame, colorBack = defaultPreset$17.params.colorBack, colorFront = defaultPreset$17.params.colorFront, density = defaultPreset$17.params.density, distortion = defaultPreset$17.params.distortion, strokeWidth = defaultPreset$17.params.strokeWidth, strokeTaper = defaultPreset$17.params.strokeTaper, strokeCap = defaultPreset$17.params.strokeCap, noiseFrequency = defaultPreset$17.params.noiseFrequency, noise = defaultPreset$17.params.noise, softness = defaultPreset$17.params.softness, fit = defaultPreset$17.params.fit, rotation = defaultPreset$17.params.rotation, scale = defaultPreset$17.params.scale, originX = defaultPreset$17.params.originX, originY = defaultPreset$17.params.originY, offsetX = defaultPreset$17.params.offsetX, offsetY = defaultPreset$17.params.offsetY, worldWidth = defaultPreset$17.params.worldWidth, worldHeight = defaultPreset$17.params.worldHeight, ...props }) {
	const uniforms = {
		u_colorBack: getShaderColorFromString(colorBack),
		u_colorFront: getShaderColorFromString(colorFront),
		u_density: density,
...
var Dithering = (0, import_react.memo)(function DitheringImpl({ speed = defaultPreset$15.params.speed, frame = defaultPreset$15.params.frame, colorBack = defaultPreset$15.params.colorBack, colorFront = defaultPreset$15.params.colorFront, shape = defaultPreset$15.params.shape, type = defaultPreset$15.params.type, pxSize, size = pxSize === void 0 ? defaultPreset$15.params.size : pxSize, fit = defaultPreset$15.params.fit, scale = defaultPreset$15.params.scale, rotation = defaultPreset$15.params.rotation, originX = defaultPreset$15.params.originX, originY = defaultPreset$15.params.originY, offsetX = defaultPreset$15.params.offsetX, offsetY = defaultPreset$15.params.offsetY, worldWidth = defaultPreset$15.params.worldWidth, worldHeight = defaultPreset$15.params.worldHeight, ...props }) {
	const uniforms = {
		u_colorBack: getShaderColorFromString(colorBack),
		u_colorFront: getShaderColorFromString(colorFront),
...
var GrainGradient = (0, import_react.memo)(function GrainGradientImpl({ speed = defaultPreset$14.params.speed, frame = defaultPreset$14.params.frame, colorBack = defaultPreset$14.params.colorBack, colors = defaultPreset$14.params.colors, softness = defaultPreset$14.params.softness, intensity = defaultPreset$14.params.intensity, noise = defaultPreset$14.params.noise, shape = defaultPreset$14.params.shape, fit = defaultPreset$14.params.fit, scale = defaultPreset$14.params.scale, rotation = defaultPreset$14.params.rotation, originX = defaultPreset$14.params.originX, originY = defaultPreset$14.params.originY, offsetX = defaultPreset$14.params.offsetX, offsetY = defaultPreset$14.params.offsetY, worldWidth = defaultPreset$14.params.worldWidth, worldHeight = defaultPreset$14.params.worldHeight, ...props }) {
	const uniforms = {
		u_colorBack: getShaderColorFromString(colorBack),
		u_colors: colors.map(getShaderColorFromString),
		u_colorsCount: colors.length,
...
var PulsingBorder = (0, import_react.memo)(function PulsingBorderImpl({ speed = defaultPreset$13.params.speed, frame = defaultPreset$13.params.frame, colors = defaultPreset$13.params.colors, colorBack = defaultPreset$13.params.colorBack, roundness = defaultPreset$13.params.roundness, thickness = defaultPreset$13.params.thickness, aspectRatio = defaultPreset$13.params.aspectRatio, softness = defaultPreset$13.params.softness, bloom = defaultPreset$13.params.bloom, intensity = defaultPreset$13.params.intensity, spots = defaultPreset$13.params.spots, spotSize = defaultPreset$13.params.spotSize, pulse = defaultPreset$13.params.pulse, smoke = defaultPreset$13.params.smoke, smokeSize = defaultPreset$13.params.smokeSize, margin, marginLeft = margin ?? defaultPreset$13.params.marginLeft, marginRight = margin ?? defaultPreset$13.params.marginRight, marginTop = margin ?? defaultPreset$13.params.marginTop, marginBottom = margin ?? defaultPreset$13.params.marginBottom, fit = defaultPreset$13.params.fit, rotation = defaultPreset$13.params.rotation, scale = defaultPreset$13.params.scale, originX = defaultPreset$13.params.originX, originY = defaultPreset$13.params.originY, offsetX = defaultPreset$13.params.offsetX, offsetY = defaultPreset$13.params.offsetY, worldWidth = defaultPreset$13.params.worldWidth, worldHeight = defaultPreset$13.params.worldHeight, ...props }) {
	const uniforms = {
		u_colorBack: getShaderColorFromString(colorBack),
		u_colors: colors.map(getShaderColorFromString),
		u_colorsCount: colors.length,
...
var ColorPanels = (0, import_react.memo)(function ColorPanelsImpl({ speed = defaultPreset$12.params.speed, frame = defaultPreset$12.params.frame, colors = defaultPreset$12.params.colors, colorBack = defaultPreset$12.params.colorBack, angle1 = defaultPreset$12.params.angle1, angle2 = defaultPreset$12.params.angle2, length = defaultPreset$12.params.length, edges = defaultPreset$12.params.edges, blur = defaultPreset$12.params.blur, fadeIn = defaultPreset$12.params.fadeIn, fadeOut = defaultPreset$12.params.fadeOut, density = defaultPreset$12.params.density, gradient = defaultPreset$12.params.gradient, fit = defaultPreset$12.params.fit, scale = defaultPreset$12.params.scale, rotation = defaultPreset$12.params.rotation, originX = defaultPreset$12.params.originX, originY = defaultPreset$12.params.originY, offsetX = defaultPreset$12.params.offsetX, offsetY = defaultPreset$12.params.offsetY, worldWidth = defaultPreset$12.params.worldWidth, worldHeight = defaultPreset$12.params.worldHeight, ...props }) {
	const uniforms = {
		u_colors: colors.map(getShaderColorFromString),
		u_colorsCount: colors.length,
		u_colorBack: getShaderColorFromString(colorBack),
...
var StaticMeshGradient = (0, import_react.memo)(function StaticMeshGradientImpl({ speed = defaultPreset$11.params.speed, frame = defaultPreset$11.params.frame, colors = defaultPreset$11.params.colors, positions = defaultPreset$11.params.positions, waveX = defaultPreset$11.params.waveX, waveXShift = defaultPreset$11.params.waveXShift, waveY = defaultPreset$11.params.waveY, waveYShift = defaultPreset$11.params.waveYShift, mixing = defaultPreset$11.params.mixing, grainMixer = defaultPreset$11.params.grainMixer, grainOverlay = defaultPreset$11.params.grainOverlay, fit = defaultPreset$11.params.fit, rotation = defaultPreset$11.params.rotation, scale = defaultPreset$11.params.scale, originX = defaultPreset$11.params.originX, originY = defaultPreset$11.params.originY, offsetX = defaultPreset$11.params.offsetX, offsetY = defaultPreset$11.params.offsetY, worldWidth = defaultPreset$11.params.worldWidth, worldHeight = defaultPreset$11.params.worldHeight, ...props }) {
	const uniforms = {
		u_colors: colors.map(getShaderColorFromString),
		u_colorsCount: colors.length,
...
var StaticRadialGradient = (0, import_react.memo)(function StaticRadialGradientImpl({ speed = defaultPreset$10.params.speed, frame = defaultPreset$10.params.frame, colorBack = defaultPreset$10.params.colorBack, colors = defaultPreset$10.params.colors, radius = defaultPreset$10.params.radius, focalDistance = defaultPreset$10.params.focalDistance, focalAngle = defaultPreset$10.params.focalAngle, falloff = defaultPreset$10.params.falloff, grainMixer = defaultPreset$10.params.grainMixer, mixing = defaultPreset$10.params.mixing, distortion = defaultPreset$10.params.distortion, distortionShift = defaultPreset$10.params.distortionShift, distortionFreq = defaultPreset$10.params.distortionFreq, grainOverlay = defaultPreset$10.params.grainOverlay, fit = defaultPreset$10.params.fit, rotation = defaultPreset$10.params.rotation, scale = defaultPreset$10.params.scale, originX = defaultPreset$10.params.originX, originY = defaultPreset$10.params.originY, offsetX = defaultPreset$10.params.offsetX, offsetY = defaultPreset$10.params.offsetY, worldWidth = defaultPreset$10.params.worldWidth, worldHeight = defaultPreset$10.params.worldHeight, ...props }) {
	const uniforms = {
		u_colorBack: getShaderColorFromString(colorBack),
		u_colors: colors.map(getShaderColorFromString),
		u_colorsCount: colors.length,
...
var PaperTexture = (0, import_react.memo)(function PaperTextureImpl({ speed = defaultPreset$9.params.speed, frame = defaultPreset$9.params.frame, colorFront = defaultPreset$9.params.colorFront, colorBack = defaultPreset$9.params.colorBack, image = "", contrast = defaultPreset$9.params.contrast, roughness = defaultPreset$9.params.roughness, fiber = defaultPreset$9.params.fiber, crumples = defaultPreset$9.params.crumples, folds = defaultPreset$9.params.folds, drops = defaultPreset$9.params.drops, seed = defaultPreset$9.params.seed, fiberScale, fiberSize = fiberScale === void 0 ? defaultPreset$9.params.fiberSize : .2 / fiberScale, crumplesScale, crumpleSize = crumplesScale === void 0 ? defaultPreset$9.params.crumpleSize : .2 / crumplesScale, blur, fade = blur === void 0 ? defaultPreset$9.params.fade : blur, foldsNumber, foldCount = foldsNumber === void 0 ? defaultPreset$9.params.foldCount : foldsNumber, fit = defaultPreset$9.params.fit, scale = defaultPreset$9.params.scale, rotation = defaultPreset$9.params.rotation, originX = defaultPreset$9.params.originX, originY = defaultPreset$9.params.originY, offsetX = defaultPreset$9.params.offsetX, offsetY = defaultPreset$9.params.offsetY, worldWidth = defaultPreset$9.params.worldWidth, worldHeight = defaultPreset$9.params.worldHeight, ...props }) {
...
var FlutedGlass = (0, import_react.memo)(function FlutedGlassImpl({ speed = defaultPreset$8.params.speed, frame = defaultPreset$8.params.frame, colorBack = defaultPreset$8.params.colorBack, colorShadow = defaultPreset$8.params.colorShadow, colorHighlight = defaultPreset$8.params.colorHighlight, image = "", shadows = defaultPreset$8.params.shadows, angle = defaultPreset$8.params.angle, distortion = defaultPreset$8.params.distortion, distortionShape = defaultPreset$8.params.distortionShape, highlights = defaultPreset$8.params.highlights, shape = defaultPreset$8.params.shape, shift = defaultPreset$8.params.shift, blur = defaultPreset$8.params.blur, edges = defaultPreset$8.params.edges, margin, marginLeft = margin ?? defaultPreset$8.params.marginLeft, marginRight = margin ?? defaultPreset$8.params.marginRight, marginTop = margin ?? defaultPreset$8.params.marginTop, marginBottom = margin ?? defaultPreset$8.params.marginBottom, grainMixer = defaultPreset$8.params.grainMixer, grainOverlay = defaultPreset$8.params.grainOverlay, stretch = defaultPreset$8.params.stretch, count, size = count === void 0 ? defaultPreset$8.params.size : Math.pow(1 / (count * 1.6), 1 / 6) / .7 - .5, fit = defaultPreset$8.params.fit, scale = defaultPreset$8.params.scale, rotation = defaultPreset$8.params.rotation, originX = defaultPreset$8.params.originX, originY = defaultPreset$8.params.originY, offsetX = defaultPreset$8.params.offsetX, offsetY = defaultPreset$8.params.offsetY, worldWidth = defaultPreset$8.params.worldWidth, worldHeight = defaultPreset$8.params.worldHeight, ...props }) {
	const uniforms = {
		u_image: image,
		u_colorBack: getShaderColorFromString(colorBack),
...
var Water = (0, import_react.memo)(function WaterImpl({ speed = defaultPreset$7.params.speed, frame = defaultPreset$7.params.frame, colorBack = defaultPreset$7.params.colorBack, colorHighlight = defaultPreset$7.params.colorHighlight, image = "", highlights = defaultPreset$7.params.highlights, layering = defaultPreset$7.params.layering, waves = defaultPreset$7.params.waves, edges = defaultPreset$7.params.edges, caustic = defaultPreset$7.params.caustic, effectScale, size = effectScale === void 0 ? defaultPreset$7.params.size : 10 / 9 / effectScale - 1 / 9, fit = defaultPreset$7.params.fit, scale = defaultPreset$7.params.scale, rotation = defaultPreset$7.params.rotation, originX = defaultPreset$7.params.originX, originY = defaultPreset$7.params.originY, offsetX = defaultPreset$7.params.offsetX, offsetY = defaultPreset$7.params.offsetY, worldWidth = defaultPreset$7.params.worldWidth, worldHeight = defaultPreset$7.params.worldHeight, ...props }) {
	const uniforms = {
		u_image: image,
		u_colorBack: getShaderColorFromString(colorBack),
		u_colorHighlight: getShaderColorFromString(colorHighlight),
...
var ImageDithering = (0, import_react.memo)(function ImageDitheringImpl({ speed = defaultPreset$6.params.speed, frame = defaultPreset$6.params.frame, colorFront = defaultPreset$6.params.colorFront, colorBack = defaultPreset$6.params.colorBack, colorHighlight = defaultPreset$6.params.colorHighlight, image = "", type = defaultPreset$6.params.type, colorSteps = defaultPreset$6.params.colorSteps, originalColors = defaultPreset$6.params.originalColors, inverted = defaultPreset$6.params.inverted, pxSize, size = pxSize === void 0 ? defaultPreset$6.params.size : pxSize, fit = defaultPreset$6.params.fit, scale = defaultPreset$6.params.scale, rotation = defaultPreset$6.params.rotation, originX = defaultPreset$6.params.originX, originY = defaultPreset$6.params.originY, offsetX = defaultPreset$6.params.offsetX, offsetY = defaultPreset$6.params.offsetY, worldWidth = defaultPreset$6.params.worldWidth, worldHeight = defaultPreset$6.params.worldHeight, ...props }) {
	const uniforms = {
		u_image: image,
		u_colorFront: getShaderColorFromString(colorFront),
		u_colorBack: getShaderColorFromString(colorBack),
...
//#endregion
//#region ../node_modules/@paper-design/shaders-react/dist/shaders/lens-distortion.js
var defaultPreset$5 = {
	name: "Default",
	params: {
		...defaultObjectSizing,
...
var LensDistortion = (0, import_react.memo)(function LensDistortionImpl({ speed = defaultPreset$5.params.speed, frame = defaultPreset$5.params.frame, image = "", spread = defaultPreset$5.params.spread, bias = defaultPreset$5.params.bias, angle = defaultPreset$5.params.angle, perspective = defaultPreset$5.params.perspective, count = defaultPreset$5.params.count, dispersion = defaultPreset$5.params.dispersion, dispersionShift = defaultPreset$5.params.dispersionShift, dispersionColor = defaultPreset$5.params.dispersionColor, focusCenter = defaultPreset$5.params.focusCenter, focusEdges = defaultPreset$5.params.focusEdges, swirl = defaultPreset$5.params.swirl, noise = defaultPreset$5.params.noise, noiseFrequency = defaultPreset$5.params.noiseFrequency, noiseOffset = defaultPreset$5.params.noiseOffset, lensBulge = defaultPreset$5.params.lensBulge, lensCircle = defaultPreset$5.params.lensCircle, grainMixer = defaultPreset$5.params.grainMixer, grainOverlay = defaultPreset$5.params.grainOverlay, imageX = defaultPreset$5.params.imageX, imageY = defaultPreset$5.params.imageY, fit = defaultPreset$5.params.fit, scale = defaultPreset$5.params.scale, rotation = defaultPreset$5.params.rotation, originX = defaultPreset$5.params.originX, originY = defaultPreset$5.params.originY, offsetX = defaultPreset$5.params.offsetX, offsetY = defaultPreset$5.params.offsetY, worldWidth = defaultPreset$5.params.worldWidth, worldHeight = defaultPreset$5.params.worldHeight, ...props }) {
	const uniforms = {
		u_image: image,
		u_spread: spread,
		u_bias: bias,
